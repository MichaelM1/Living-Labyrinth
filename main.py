...
class Game(object):
    def __init__(self):
        ...
        self.player = player.Player(608, 352, self.data, self.maze, self.exit)
        self.run = True
        self.time = 0
...
def menuStart():
    ...
    while menu:
        ...
        quitButton = pygame.image.load('assets/quit.PNG')
        win.blit(quitButton, (450, 400))
        ...
        if x > 450 and x < 815 and y > 400 and y < 494 and mouse == 1:
            menu = False
        if x > 650 and x < 1015 and y > 300 and y < 394 and mouse == 1:
            #game.startSingle()
            menu = False
        pygame.display.flip()
