...
player = pygame.image.load('s.png').convert_alpha()
...
walls = []
walz = pygame.image.load('wall.png')
class Wall(object):
    def __init__(self,pos):
        self.player_width  = width = 50
        self.player_height = height = 50
        w = pygame.image.load('wall.png').convert()
